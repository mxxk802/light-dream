...
/**
 * FreeMarkerTest 测试使用freemarker生成word各种数据填入
 *
 * @auther zhang
 * @date 2020/12/23
 **/
...
public class FreeMarkerTest {
    ...
    public void createDoc(){
          String src= StringUtils.formatFilePath(PathUtils.templatePath+"freemarkerTest.docx");

        try {
            InputStream in=new FileInputStream(src);
            ExportData exportData= WordUtils.createExportData(in,"freemarker");
            ...
            exportData.setData("title","Freemarker制作word简述");
           ...
           // exportData.putDataToFieldMeta("song",String.class,true);
            ...
            String outDoc=PathUtils.word_Path+"freemarkerResult.docx";
