...
<div class="demo">
    <div class="row">
        ...
        <div class="col-md-3">
            <button type="button" class="btn btn-success"  style="margin-left: 90%;" onclick="create()">新建</button>&nbsp;&nbsp;
        </div>
    </div>
    <%--<div align="center"><h2>Blue</h2><h2>search</h2></div>--%>
    <form action="/video/" method="post" name="searchform" id="searchform" class="searchinfo">
        <ul>
            <li><input type="text" id="siteVal" value="" class="text" /></li>
